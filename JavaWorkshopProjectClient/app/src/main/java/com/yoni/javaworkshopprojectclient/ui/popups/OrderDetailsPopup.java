...
// todo - this classes has not been implemented yet, only copied an existing one so far
public class OrderDetailsPopup extends AlertDialog {

    protected OrderDetailsPopup(Context context, List<ProductCategory> existingSelectedCategories, Consumer<List<ProductCategory>> onCategoriesSelected) {
